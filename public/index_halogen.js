(() => {
              ...
              function go2(bot, top2) {
                switch (top2 - bot) {
                  ...
                  default:
                    ...
                    return apply3(map23(concat2)(go2(bot, pivot)))(go2(pivot, top2));
                }
              }
    ...
    return function(req) {
      ...
      var extractContent = function(v2) {
        ...
        if (v2 instanceof FormURLEncoded) {
          return note("Body contains values that cannot be encoded as application/x-www-form-urlencoded")(map7(unsafeToForeign)(encode2(v2.value0)));
        }
        ;
      ...
      var headers = function(reqContent) {
        return addHeader(map7(ContentType.create)(bindFlipped4(toMediaType2)(reqContent)))(addHeader(map7(Accept.create)(toMediaType(req.responseFormat)))(req.headers));
      };
  ...
  var MakeRequest = /* @__PURE__ */ function() {
    ...
    ;
    MakeRequest2.value = new MakeRequest2();
    return MakeRequest2;
  }();
  var outer_style = /* @__PURE__ */ function() {
    return "display: inline-flex;margin: 1em;padding:1em;background: lightcyan;";
  }();
  ...
  var handleAction = function(dictMonadAff) {
    ...
    var getArgs = "pwd=/home/jacek/&show_hidden=true";
    return function(v) {
      ...
      if (v instanceof Decrement) {
        return modify_3(function(st) {
          ...
          ;
          $31.count = st.count - 1 | 0;
          return $31;
        });
      }
      ;
      if (v instanceof MakeRequest) {
        return discard2(modify_3(function(st) {
          var $34 = {};
          for (var $35 in st) {
          ...
          return bind3(liftAff2(get2(string)("http://localhost:3000/api/get-files" + ("?" + getArgs))))(function(response) {
            return modify_3(function(st) {
              var $37 = {};
              for (var $38 in st) {
      ...
      ;
      throw new Error("Failed pattern match at App.Counter (line 89, column 16 - line 102, column 8): " + [v.constructor.name]);
    };
  };
  var counter_color = function(count) {
    var $40 = count === 0;
    if ($40) {
  ...
  var render = function(state3) {
    return div2([])([div2([style(outer_style), class_("first-class")])([button([onClick(function(v) {
      return Decrement.value;
    })])([text("-")]), p([style("background: white; padding: 1em")])([text("You counted "), span2([style("padding: 0.25em; " + counter_color(state3.count))])([text(show2(state3.count))]), text(" times")]), button([onClick(function(v) {
      return Increment.value;
    })])([text("+")])]), div2([])([p([])([button([onClick(function(v) {
      return MakeRequest.value;
    })])([text("Get the data")])]), div_(function() {
      if (state3.result instanceof Nothing) {
        return [];
      }
      ;
      if (state3.result instanceof Just) {
        return [h2_([text("Response:")]), p_([text(state3.result.value0)]), p_([footer_([text("Footer")])])];
      }
      ;
      throw new Error("Failed pattern match at App.Counter (line 71, column 15 - line 82, column 20): " + [state3.result.constructor.name]);
    }())])]);
  };
