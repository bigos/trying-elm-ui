...
var $author$project$ElmFormNew$Model = F3(
	function (name, password, passwordAgain) {
		return {name: name, password: password, passwordAgain: passwordAgain};
	});
var $author$project$ElmFormNew$init = A3($author$project$ElmFormNew$Model, '', '', '');
...
var $author$project$ElmFormNew$main = $elm$browser$Browser$sandbox(
	{init: $author$project$ElmFormNew$init, update: $author$project$ElmFormNew$update, view: $author$project$ElmFormNew$view});
